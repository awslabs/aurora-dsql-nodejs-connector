# Aurora DSQL Postgres.js Connector

The Aurora DSQL Postgres.js Connector is a Node.js connector built on [Postgres.js](https://github.com/porsager/postgres) 
that integrates IAM Authentication for connecting JavaScript applications to Amazon Aurora DSQL clusters.

The Aurora DSQL Postgres.js Connector is designed as an authentication plugin that extends the functionality of the
...
The idea behind the Aurora DSQL Postgres.js Connector is to add an authentication layer on top of the Postgres.js 
...
- **Built on Postgres.js** - Leverages the fastest PostgreSQL client for Node.js
